...
import gui.automation.GUI_FontSizeAdjustable;
...
public interface GUI_Settings_Variables extends GUI_FontSizeAdjustable{
	...
	int txtSize_JMenuBar = txtSize_Regular + 3 *txtSizeFactor;
	int txtSize_JMenu = txtSize_Regular +  3 * txtSizeFactor;
...
//	Color allSelectionHoldersPanelsForegroundColor = Color.BLUE;
	...
	Color clrB_JTextField = Color.WHITE;
	...
	Color clrB_JTableCellHead = Color.LIGHT_GRAY;
